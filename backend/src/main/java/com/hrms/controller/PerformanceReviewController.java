...
/**
 * PerformanceReview REST Controller
 * Module: PERFORMANCE
 */
@RestController
...
public class PerformanceReviewController {
    ...
    public ResponseEntity<Page<PerformanceReview>> getAll(
            ...
            Pageable pageable) {
        try {
            Page<PerformanceReview> records = service.getByOrganization(organizationId, pageable);
     ...
     */
    @GetMapping("/all")
    public ResponseEntity<List<PerformanceReview>> getAllNoPagination(@RequestParam UUID organizationId) {
        try {
            List<PerformanceReview> records = service.getAllByOrganization(organizationId);
            return ResponseEntity.ok(records);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).build();
        }
    ...
    public ResponseEntity<PerformanceReview> create(@RequestBody PerformanceReview entity) {
        try {
            PerformanceReview created = service.create(entity);
    ...
    public ResponseEntity<PerformanceReview> update(
            ...
            @RequestBody PerformanceReview entity) {
        try {
            PerformanceReview updated = service.update(id, entity);
