...
public interface AssetRepository extends JpaRepository<Asset, UUID> {
     ...
     */
    @Query("SELECT e FROM Asset e WHERE e.organizationId = :organizationId")
    Page<Asset> findByOrganizationId(@Param("organizationId") UUID organizationId, Pageable pageable);
