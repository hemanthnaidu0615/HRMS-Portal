...
public interface LeaveTypeRepository extends JpaRepository<LeaveType, UUID> {
     ...
     */
    @Query("SELECT e FROM LeaveType e WHERE e.organizationId = :organizationId")
    Page<LeaveType> findByOrganizationId(@Param("organizationId") UUID organizationId, Pageable pageable);
