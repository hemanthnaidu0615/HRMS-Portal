...
const AssetsFormPage: React.FC = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      message.error(error.response?.data?.message || `Failed to ${isEdit ? 'update' : 'create'} assets`);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div>
      <Card title={isEdit ? `Edit Assets` : `Create Assets`}>
        <Form
          form={form}
          layout="vertical"
          onFinish={onFinish}
        >
          <Form.Item
            name="assetName"
            label="Assetname"
            rules={[{ required: true, message: 'Please enter assetname' }]}
          >
            <Input placeholder="Enter assetname" />
          </Form.Item>
<Form.Item
            name="assetCode"
            label="Assetcode"
          ...
          >
            <Input placeholder="Enter assetcode" />
          </Form.Item>
<Form.Item
            name="category"
            label="Category"
...
<Form.Item
          ...
          <Form.Item>
            <Space>
              ...
              <Button onClick={() => navigate(`/admin/assets/assets`)}>
                Cancel
              </Button>
            </Space>
          </Form.Item>
